        ...
        <div ref={scrollRef} className="fixed inset-0 w-screen h-[100dvh] z-[9999] overflow-y-auto overflow-x-hidden font-sans flex flex-col" style={{ backgroundColor: theme.bg, color: theme.text }}>
            ...
            <main className="w-full max-w-none px-6 md:px-12 lg:px-24 pt-16 pb-24 mb-12 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10 flex-1">
                ...
                <motion.div initial="hidden" animate="visible" variants={fadeUp} className="w-full lg:w-[50%] xl:w-[45%] z-10 flex flex-col items-start justify-center text-left">
                    ...
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/40 mb-8 bg-[#00A9F7]/10">
                    ...
                    {/* Massive Title */}
                    <h1 className="text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem] font-black leading-[1.1] tracking-tighter mb-6 text-[#FFFFFF]">
                    ...
                    {/* Subtitle */}
                    <p className="text-[1.15rem] md:text-[1.3rem] text-[#FFFFFF] font-medium leading-[1.6] mb-12 opacity-90">
                        {currentT.main_sub}
                    </p>
                    ...
                    <button 
                        ...
                        className="w-full sm:w-auto px-10 py-4 rounded-xl font-black text-[1.1rem] transition-transform hover:scale-105 outline-none shadow-[0_10px_30px_rgba(0,169,247,0.3)] mb-16 flex items-center justify-center gap-2"
                    >
                    ...
                    <div className="grid grid-cols-2 gap-x-12 gap-y-10 w-full max-w-[500px]">
                        {[
                            ...
                            <div key={idx} className="flex flex-col items-start text-left">
                                <div className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center mb-3 bg-[#00A9F7]/10">
